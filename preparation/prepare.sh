...
aws dynamodb put-item \
    --table-name $TABLE_NAME \
    --item '{"name": {"S": "restaurant-1"}, "restaurantcount": {"N": "0"}}' \
    --region $AWS_REGION 
    
aws dynamodb put-item \
    --table-name $TABLE_NAME \
    --item '{"name": {"S": "restaurant-2"}, "restaurantcount": {"N": "0"}}' \
    --region $AWS_REGION 

aws dynamodb put-item \
    --table-name $TABLE_NAME \
    --item '{"name": {"S": "restaurant-3"}, "restaurantcount": {"N": "0"}}' \
    --region $AWS_REGION 

aws dynamodb put-item \
    --table-name $TABLE_NAME \
    --item '{"name": {"S": "restaurant-4"}, "restaurantcount": {"N": "0"}}' \
    --region $AWS_REGION 
